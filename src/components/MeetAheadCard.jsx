    ...
    <div className="px-20 relative mt-7 mb-32">
      ...
      >
        ...
        >
          ...
          >
            <img height={100} width={100} src="https://github.com/Stutimaha/Ahead-App-Redesign/blob/main/public/newGhost.png?raw=true" className="h-full w-full" alt="" />
          </motion.div>
          {/*Badge*/}
          <motion.div
            whileInView="visible"
            ...
            style={{ top: "-22px" }}
          >
            <img height={100} width={100} src="https://github.com/Stutimaha/Ahead-App-Redesign/blob/main/public/badge.png?raw=true" alt="" />
          </motion.div>
        </div>
      </div>
      {/* flower div */}
      ...
      >
        <img height={100} width={100}src="https://github.com/Stutimaha/Ahead-App-Redesign/blob/main/public/flower.png?raw=true" alt="" />
      </motion.div>
    </div>
  );
};
